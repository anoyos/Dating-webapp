...
namespace james.Migrations
{
    ...
    [Migration("20220831143219_log-tb")]
    partial class logtb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("james.Models.DB.ErrorLog", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("james.Models.DB.Streaming", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("james.Models.DB.StreamingActivity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("streamingActivities");
                });

            modelBuilder.Entity("james.Models.DB.StreamingMember", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("james.Models.DB.StreamingActivity", b =>
                {
                    b.HasOne("james.Models.DB.StreamingActivity", "parent")
                        .WithMany()
                        .HasForeignKey("parentId");

                    b.HasOne("james.Models.DB.Streaming", "stream")
                        .WithMany("activities")
